...
# print possible_hands([], 1, ['2H', '2S', 'JC', '8C', '7H', 'TH', 'JH', 'QH', 'JS', '7C'])
...
# print optimize_hand([['TC', 'AH'], ['2H', '2D', '3S', '4C'], ['8S', '8C', 'TS', 'TD']], ['TH', '2S', '3H'], True)

game = g.PineappleGame1()
draw = random.sample(game.cards, 14)
print "Random draw:", g.sort_cards(draw)
print optimize_hand([[], [], []], draw, True)